...
// if everything is ok, try to upload file
	...
	setInterval(function() {
            ...
            if (count <= 0) {window.location.replace('./viewProfile.php');  }
        }, 1000);
    </script>
	<img src='../tutor/loader.gif' class='img-fluid' alt='Responsive image' />
	<br/>
	<a href = './viewProfile.php'>Alternatively you can click here to redirect !</a>
	</div>
	";
