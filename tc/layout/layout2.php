...
<p>
<a href="tcModuleManagement.php"  class="button">Module Mgmt</a>
<br/>
<a href="tcTutorManagement.php" class="button"><font color="white">Tutor Mgmt</font></a>
<br/>
<a href="studentEnrollment.php" class="button"><font color="white">Enrollment Mgmt</font></a>
<br/>
<br/>
<a href="../chatwall/chatwall.php" target="_blank" class="button button3">Chat App </a> <br/>
<br/>
<a href=""><font color="white" class="button">My Profile</font></a>
<br/>
<a href="paymentDetails.php"><font color="white" class="button">Payment Details</font></a>
