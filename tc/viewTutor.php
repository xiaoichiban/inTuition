...
if (mysqli_num_rows($result) != 1) {
  ...
  "<tr><th>Number of Modules Taught</th><th>" . mysqli_fetch_row(mysqli_query($db, "SELECT COUNT(*) FROM module, tutor where module.tutor = tutor AND tutor.id = '$tutor_id';"))[0] . "</th></tr>" .
  "</table>";
}
